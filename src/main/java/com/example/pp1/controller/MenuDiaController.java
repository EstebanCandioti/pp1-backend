...
public class MenuDiaController {
    ...
    public ResponseEntity<?> actualizarMenuDia(@Valid @RequestBody ActualizarMenuDiaDTO menu) {
    ...
    public ResponseEntity<?> crearMenuDia(@Valid @RequestBody CrearMenuDiaDTO menu) {
